...
export const systemFields = ['id', 'createdAt', 'updatedAt', 'tenantId'];
...
export const CustomFieldsSchema = z
    ...
    .describe('Custom Fields - allows for arbitrary key-value pairs to be added to an entity. Useful for storing any custom data that is not covered by the other fields.');
export const AddressSchema = z
    ...
    stateOrProvince: z
        .string()
        .describe('State or province. For US addresses, use 2-letter state code (e.g., "CA", "NY"). For other countries, use full province name or local standard.'),
    zipCodeOrPostalCode: z.string().describe('ZIP code (US) or postal code (international) for the address'),
})
    .partial()
    .required(makeZodFieldMap([]));
...
export const OrderLineItemSchema = z
    ...
    .partial()
    .required(makeZodFieldMap(['sku', 'quantity']));
/**
...
export const TagsSchema = z
    .array(z.string())
    .describe('Tags for categorization and filtering. Useful for organizing entities with custom labels (e.g., "priority", "wholesale", "gift")');
/**
