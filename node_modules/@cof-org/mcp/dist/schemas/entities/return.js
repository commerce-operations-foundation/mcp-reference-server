...
export const ReturnLineItemSchema = z
    ...
    returnReason: z
        .string()
        .describe('Primary return reason code (e.g., "defective", "wrong_item", "no_longer_needed", "size_issue", "quality_issue")'),
    ...
    .partial()
    .required(makeZodFieldMap(['orderLineItemId', 'sku', 'quantityReturned', 'returnReason']));
/**
...
export const ReturnLabelSchema = z
    ...
    .partial()
    .required(makeZodFieldMap(['carrier', 'trackingNumber']));
/**
...
const ReturnCoreSchema = z
    ...
    .partial()
    .required(makeZodFieldMap(['orderId', 'outcome', 'returnLineItems']))
