import { z } from 'zod';
import { AddressSchema, OrderLineItemSchema, ObjectProps, TagsSchema, CustomFieldsSchema, ShippingInfoSchema, } from '../common.js';
...
const OrderCoreSchema = z
    ...
    .partial()
    .required(makeZodFieldMap(['lineItems']))
