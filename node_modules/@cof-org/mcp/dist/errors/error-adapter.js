...
import { InvalidParamsError, FulfillmentAdapterError, FulfillmentValidationError, ToolNotFoundError, MethodNotFoundError, } from './index.js';
/**
...
function isProtocolError(error) {
    ...
    if ('isProtocolError' in error) {
        const isProtocolErrorValue = error.isProtocolError;
...
function isRetryableError(error) {
    ...
    if ('retryable' in error) {
        const retryableValue = error.retryable;
