...
import { CallToolRequestSchema, ListToolsRequestSchema, ListPromptsRequestSchema, ListResourcesRequestSchema, PingRequestSchema, McpError, ErrorCode, } from '@modelcontextprotocol/sdk/types.js';
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                ...
                const processed = ErrorAdapter.processError(error);
