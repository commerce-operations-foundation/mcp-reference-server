 ...
 * 
 * This is a copy from server/src/types/fulfillment.ts
...
export interface OrderAddress {
  ...
  lastName?: string;
  phone?: string;
  state?: string; // Added for compatibility
...
export interface Customer {
  ...
  orgKey?: string; // readOnly
  updatedAt?: string; // date-time, readOnly
  metadata?: any; // Added for compatibility
}
...
export interface Product {
  ...
  updatedAt?: string; // date-time, readOnly
  price?: number; // Added for compatibility
  inventory?: number; // Added for compatibility
  attributes?: any; // Added for compatibility
}
...
export interface Inventory {
  ...
  locations?: any[]; // Added for compatibility
...
export interface Shipment {
  ...
  orgKey?: string; // readOnly
  updatedAt?: string; // date-time, readOnly
  carrier?: string; // Added for compatibility
  service?: string; // Added for compatibility
  shippedAt?: string; // Added for compatibility
  deliveredAt?: string; // Added for compatibility
  trackingUrl?: string; // Added for compatibility
  items?: any[]; // Added for compatibility
  fromAddress?: OrderAddress; // Added for compatibility
  toAddress?: OrderAddress; // Added for compatibility
}
...
export interface Buyer {
  userId?: string;
  buyerId?: string; // Added for compatibility
  name: string; // required
...
export interface HoldParams {
  ...
  autoRelease?: boolean;
  releaseDate?: string;
  until?: string; // Added for compatibility
}
...
export interface SplitParams {
  ...
  shipDate?: string; // Added for compatibility
}
...
export interface ReturnItem {
  lineItemId: string;
  sku?: string; // Added for compatibility
  quantity: number;
  reason: string;
...
export interface OrderUpdates {
  ...
  status?: string;
  notes?: string;
  tags?: any; // Added for compatibility
}
